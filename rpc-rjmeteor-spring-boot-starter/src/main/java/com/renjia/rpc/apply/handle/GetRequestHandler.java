...
public class GetRequestHandler extends RequestHandler {
    ...
    public void handle(RpcProtocol rpcProtocol, CompletableFuture<RpcProtocol> complet) {
        ...
        ResponseEntity exchange = restTemplate.exchange(requestUrl, HttpMethod.GET, requestEntity, rpcProtocol.getReturnType());
    ...
    public Boolean isSuport(RpcProtocol rpcProtocol) {
        return rpcProtocol.getRequestType() == RequestInfo.RequestType.GET;
    }
